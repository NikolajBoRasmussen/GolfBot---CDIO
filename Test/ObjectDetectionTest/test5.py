...
class Tests5(unittest.TestCase):
    def setUp(self):
        test_image_path = os.path.join(os.path.dirname(__file__), "test5.jpg")
    ...
    def test_can_find_objects(self):
        self.assertTrue(self.orange_ball is None or self.egg is not None or self.white_balls is None or self.cross is None or self.robot is None)
