...
class Tests11(unittest.TestCase):
    def setUp(self):
        test_image_path = os.path.join(os.path.dirname(__file__), "test11.jpg")
    ...
    def test_can_find_objects(self):
        self.assertTrue(self.orange_ball is not None or self.egg is None or self.white_balls is not None or self.cross is None or self.robot is None)
